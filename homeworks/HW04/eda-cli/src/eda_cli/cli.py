...
def report(
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        if not top_cats:
            ...
            f.write(f"Top-значений для категориальных признаков: **{top_k_categories}**\n")

        f.write("## Гистограммы числовых колонок\n\n")
        f.write("См. файлы `hist_*.png`.\n\n")
        f.write(f"Количество числовых колонок включённых в набор гистограмм: **{max_hist_columns}**")
